...
/**
 * Envoltorio de modal/overlay para "setear el saldo" de una cuenta, mismo
 * patrón que `ModalMetaAhorro.vue`/`ModalCategoria.vue`. Se abre al tocar
 * cualquier tile de `TarjetaSaldosPorCuenta` (Dashboard).
 */
defineProps<{
  bancoId: string
  moneda: Moneda
  ...
  <div class="modal-fondo">
    <div class="modal-contenido" role="dialog" aria-modal="true">
      <div class="modal-cabecera">
        <h2>Setear saldo de {{ etiqueta }}</h2>
